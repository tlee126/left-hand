...
type CourseFilter = "Tất cả" | "Zoom" | "Video" | "Online" | "Sắp mở" | "Đang nhận đăng ký";
...
export default function CoursesCatalogPage() {
  ...
  const processedCourses = useMemo(() => {
    ...
    if (filter === "Zoom") {
      ...
      result = result.filter((item) => item.format === "online" || item.format === "zoom");
      ...
      <div className="section-shell px-4 py-8 sm:px-8 sm:py-10 lg:px-10">
        ...
        <div className="mt-6">
          {processedCourses.length > 0 ? (
            ...
            <EmptyState onReset={handleReset} message="Không tìm thấy khóa học phù hợp." />
          )}
        </div>
      </div>
    </CatalogPageShell>
